...
curl -X POST \
    ...
    -d '{"Title":"Prof.","name":"John Doe","email":"johndoe2@kris.com","password":"quis","device_name":"Huawei STK-L21"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"email":"aut","password":"ab","device_name":"Huawei STK-L21"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"email":"beatae","password":"non","current_password":"dicta"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -F "file=@C:\Users\USER\AppData\Local\Temp\php14BD.tmp" 
```
...
files = {
  'file': open('C:\Users\USER\AppData\Local\Temp\php14BD.tmp', 'rb')
}
headers = {
  'Content-Type': 'multipart/form-data',
  'Accept': 'application/json'
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/publications?perPage=9&recent=2&limit=ut" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/publication/magni" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://127.0.0.1:8000/api/publication/magni"
);
...
url = 'http://127.0.0.1:8000/api/publication/magni'
headers = {
  'Authorization': 'Bearer {YOUR_AUTH_KEY}',
  'Content-Type': 'application/json',
  'Accept': 'application/json'
...
```bash
curl -X POST \
    "http://127.0.0.1:8000/api/publication/et/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
url = 'http://127.0.0.1:8000/api/publication/et/request'
headers = {
  'Content-Type': 'application/json',
  'Accept': 'application/json'
}
...
```bash
curl -X POST \
    "http://127.0.0.1:8000/api/publication/tenetur/grant" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
url = 'http://127.0.0.1:8000/api/publication/tenetur/grant'
headers = {
  'Content-Type': 'application/json',
  'Accept': 'application/json'
}
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/projects?perPage=15&recent=18&limit=architecto" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/project/rerum" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://127.0.0.1:8000/api/project/rerum"
);
...
url = 'http://127.0.0.1:8000/api/project/rerum'
headers = {
  'Authorization': 'Bearer {YOUR_AUTH_KEY}',
  'Content-Type': 'application/json',
  'Accept': 'application/json'
...
```bash
curl -X POST \
    "http://127.0.0.1:8000/api/project/sequi/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
url = 'http://127.0.0.1:8000/api/project/sequi/request'
headers = {
  'Content-Type': 'application/json',
  'Accept': 'application/json'
}
...
```bash
curl -X POST \
    "http://127.0.0.1:8000/api/project/consequatur/grant" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
url = 'http://127.0.0.1:8000/api/project/consequatur/grant'
headers = {
  'Content-Type': 'application/json',
  'Accept': 'application/json'
}
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/researchers?perPage=13&recent=12&limit=architecto" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://127.0.0.1:8000/api/researcher/at" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://127.0.0.1:8000/api/researcher/at"
);
...
url = 'http://127.0.0.1:8000/api/researcher/at'
headers = {
  'Authorization': 'Bearer {YOUR_AUTH_KEY}',
  'Content-Type': 'application/json',
  'Accept': 'application/json'
